# -*- coding: utf-8 -*-
"""
Created on Fri Dec 10 13:53:39 2021
...
#DataGenerator = mera.DataGenerator()
...
train_loader = data_func.DataGenerator(
...
#tf.keras.models.save_model(model,'models/model.h5', save_format="tf")
